...
PLUGIN_DESCRIPTION = 'Advanced free web search with built-in handlers for weather, football scores, news, science/space news, trending topics, teachable trusted source categories, summaries, and confidence scoring.'
